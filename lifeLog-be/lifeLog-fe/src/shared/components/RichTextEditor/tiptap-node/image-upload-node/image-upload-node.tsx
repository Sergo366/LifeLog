...
import { CloseIcon } from '@/shared/components/RichTextEditor/tiptap-icons/close-icon';
import '@/shared/components/RichTextEditor/tiptap-node/image-upload-node/image-upload-node.scss';
