...
// --- Icons ---
import { HeadingOneIcon } from '@/shared/components/RichTextEditor/tiptap-icons/heading-one-icon';
import { HeadingTwoIcon } from '@/shared/components/RichTextEditor/tiptap-icons/heading-two-icon';
import { HeadingThreeIcon } from '@/shared/components/RichTextEditor/tiptap-icons/heading-three-icon';
import { HeadingFourIcon } from '@/shared/components/RichTextEditor/tiptap-icons/heading-four-icon';
import { HeadingFiveIcon } from '@/shared/components/RichTextEditor/tiptap-icons/heading-five-icon';
import { HeadingSixIcon } from '@/shared/components/RichTextEditor/tiptap-icons/heading-six-icon';
